Namespace Delegates1
    ...
    Namespace ListBoxes
        Public Module Module1
            Private Delegate Sub DELappendText(ByRef Frm As Form, ByRef Box As ListBox, ByRef Text As String)
            Public Sub appendText(ByRef Frm As Form, ByRef Box As ListBox, ByRef Text As String)
